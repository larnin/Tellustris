...
ChunkRenderBehaviour::ChunkRenderBehaviour(Chunk & chunk, WorldMap & map, WorldRenderBehaviour & worldRender, int chunkX, int chunkY, TileDefinitionRef definition)
	: m_chunk(chunk)
	, m_map(map)
